...
import { hiraganaArray, katakanaArray, romajiArray, letConRomaji, kunjawKatakana } from "@/utils/letters.js"
...
export default function Page() {
	...
	function calculateScore() {
		...
		letConRomaji.forEach((romajiKey) => {
			if((enteredAnswer[romajiKey] == kunjawKatakana[romajiKey]) && (romajiKey != "")) {
				countCorrect+=1;
			}
		})
		if(countCorrect == 46) {
	...
	let hiraganaArray1 = shuffledKatakana.slice(0, 23);
	let hiraganaArray2 = shuffledKatakana.slice(23, 46);

...
function Table({character, data, isLoading}) {
    ...
    if(isMobile) {
        ...
        <div className='flex flex-col h-full select-none'>
            ...
            <div className={`${character == 'hiragana' ? 'bg-orange-200' : 'bg-green-200'}  mt-3 ${styles.card} mx-auto flex flex-col text-sm w-[380px] min-h-[25rem]`}>
            ...
            <div className='flex flex-row justify-end gap-5 mt-2 mx-auto w-[380px]'>
                <button 
